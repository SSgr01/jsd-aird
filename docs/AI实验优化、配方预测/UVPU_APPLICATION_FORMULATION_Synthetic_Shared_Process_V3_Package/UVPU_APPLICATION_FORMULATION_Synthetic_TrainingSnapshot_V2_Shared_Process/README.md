...
The generated Parquet and preview outputs are intentionally kept outside the
Git delivery branch. Use the portable demo scripts under `scripts/demo` and
`scripts/testdata` to recreate isolated acceptance data when needed.
