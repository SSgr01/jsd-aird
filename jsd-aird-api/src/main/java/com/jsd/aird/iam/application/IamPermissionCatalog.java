...
public final class IamPermissionCatalog {
    ...
    public static List<PermissionDefinition> definitions() {
        return List.of(
                ...
                p("ai.modeling.read", "ai", "查看建模设置", "LOW", "ALL"),
                p("ai.model.read", "ai", "查看模型", "LOW", "ALL"),
                p("ai.performance.predict", "ai", "性能预测", "MEDIUM", "ALL"),
                p("ai.formula.predict", "ai", "配方预测", "MEDIUM", "ALL"),
                p("ai.experiment.optimize", "ai", "实验优化", "MEDIUM", "ALL"),
                p("ai.modeling.manage", "ai", "管理建模设置", "HIGH", "ALL"),
                p("ai.data.review", "ai", "审查训练数据", "HIGH", "ALL"),
                p("ai.model.publish", "ai", "发布与回退模型", "CRITICAL", "ALL"),
                p("ai.training.operate", "ai", "操作训练任务", "HIGH", "ALL"),
                p("ai.config.manage", "ai", "管理AI配置", "CRITICAL", "ALL"),
