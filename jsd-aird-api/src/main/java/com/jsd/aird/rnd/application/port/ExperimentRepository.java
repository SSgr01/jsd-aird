...
public interface ExperimentRepository {
    ...
    record SourceReference(UUID id, UUID recognitionJobId, UUID confirmedSubmissionId,
                           Integer submissionRevision, UUID currentSubmissionId,
                           Integer currentSubmissionRevision, String sourceOwner,
                           String recognitionMode,
                           UUID sourceFileId, String sourceFileName, String sourceFileSha256,
                           String experimentBoundaryId, String sampleBoundaryId,
                           String logicalSampleKey, List<String> sourceGroupKeys, JsonNode sourceCoordinates,
                           JsonNode recognitionSnapshot, String contentHash,
                           boolean sourceUpdated, Instant createdAt) {}
    ...
    List<SourceReference> sourceReferences(UUID organizationId, UUID experimentId);
